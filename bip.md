...
description will completely coincide with that of BIP39, and as a consequence, some excerpts 
of this document will be verbatim transcriptions of those of BIP39.**
...
he case for this format is very simple: 
* It keeps all BIP39 properties, specifically:
   a) every 33 bits is checksum;
   b) information density: 11 bits every 4 unique first letters;
